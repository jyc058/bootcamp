...
public class DemoOptional {
  ...
  private Optional<String> name; // For attribute, alwways use null to present "no value", instead of Optional
  ...
  public static void main(String[] args) {
    ...
    //Option.of(null); // ! You must put non-null object into of()
