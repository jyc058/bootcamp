...
public class DataStructureExercise {
  public static void main(String[] args) {
    ...
    duplicateNumbers.add(20);
    duplicateNumbers.add(50);
    Set<Integer> uniqueNumbers = new HashSet<>(duplicateNumbers);
    ...
    numberSet.add(4.4);
    numberSet.add(5.5);
    System.out.println(numberSet.contains(3.3));
    numberSet.remove(2.2);
    ...
    name.add("Jenny");
    name.add("Vicky");
    List<String> namesList = new ArrayList<>(name);
