public class DemoWrapper {
  public static void main(String[] args) {
    ...
    System.out.println(c1.compareTo(Character.valueOf('b'))); // -2
    ...
    // int value -> long value -> long (NOT OK for aut-conversion)
    // Long l2 = 2; not ok!
    ...
    for (int i = 0; i < word.length(); i++) {
      if (word.charAt(i) == word.charAt(word.length() - i - 1)) {
        // System.out.println(word.concat("this character value is Palindromic"));
        counter++;
        ...
        // System.out.println(word.concat("this is not"));
      }
    }
    int detector = word.length() / 2;
    if (counter > detector) {
